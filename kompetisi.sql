...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Apr 2022 pada 03.52
...
('Arsenal', 'Emirates Stadium', 'Mikel Arteta', 6, 2, 1, 0, 5, 2, 3),
...
--
ALTER TABLE `jadwal`
  MODIFY `id_pertandingan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
